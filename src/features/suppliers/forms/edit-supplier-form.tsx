...
import type { IEditSupplierProps } from "../props/edit-supplier-props";
...
export function EditSupplierForm({
  ...
  supplier,
  ...props
}: IEditSupplierProps & Omit<React.ComponentProps<"div">, "onSubmit">) {
  const [cities, setCities] = useState<CityModel[]>([]);
  const [selectedCityId, setSelectedCityId] = useState<number>(supplier.cityId || 0);
  ...
  const form = useForm<z.infer<typeof supplierSchema>>({
    ...
    defaultValues: {
      ...
      id: supplier?.id || "",
      cityId: supplier?.cityId || 0,
      districtId: supplier?.districtId || 0,
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select
                  ...
                  defaultValue={
                    supplier.cityId !== undefined
                      ? String(supplier.cityId)
                      : undefined
                  }
                >
                  <FormControl>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <Select
                  ...
                  defaultValue={
                    supplier.districtId !== undefined
                      ? String(supplier.districtId)
                      : undefined
                  }
                >
                  <FormControl>
